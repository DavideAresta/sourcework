...
- Stop the settings page racing the restart it asked for
- Treat a claude-code session limit as a quota hit so failover runs
...
- Build the AppImage again, with Tcl/Tk pruned from the runtime

## [0.6.6] — 2026-09-11

### Changed

- Stop the bundle globs swallowing pip's Windows launchers

## [0.6.5] — 2026-09-11

### Changed

- Ship the Linux .deb, not the AppImage

## [0.6.4] — 2026-09-11

### Changed

- Run linuxdeploy without FUSE so the AppImage builds
