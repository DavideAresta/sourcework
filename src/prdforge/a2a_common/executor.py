...
from prdforge import usage
from prdforge.a2a_common.parts import model_part, read_envelope, text_summary_part, usage_part
from prdforge.config import LLMOverrides, llm_overrides
from prdforge.stream import Narrator, decode, encode, stream_to
...
def _narration_publisher(updater: TaskUpdater, skill_id: str):  # noqa: ANN202
    ...
    every caller; the marker in :func:`prdforge.stream.encode` is what keeps a
