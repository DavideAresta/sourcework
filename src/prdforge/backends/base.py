...
:class:`~prdforge.llm.LLM` does not know how a model is reached. It hands a
...
* **API** - :mod:`prdforge.backends.litellm_backend`. One HTTPS call, the
...
:mod:`prdforge.backends.process`, rather than three times over.
"""
...
class ImageInput(BaseModel):
    ...
    (see :func:`prdforge.backends.process.staged_media`) because their
