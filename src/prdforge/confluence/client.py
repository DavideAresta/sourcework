...
from prdforge.config import ConfluenceSettings, settings
...
class ConfluenceClient:
    ...
    async def __aenter__(self) -> ConfluenceClient:
        if not self.cfg.configured:
            raise ConfluenceError(
                "Confluence is not configured: set PRDFORGE_CONFLUENCE__EMAIL and "
    ...
    async def update_page(
        ...
        title: str,
        storage_xhtml: str,
        version_message: str = "Updated by PRD Forge",
    ) -> dict[str, Any]:
