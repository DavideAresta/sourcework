...
* **Nothing in the middle wants to know about it.** An agent calls
  ...
  whoever is watching and read by :mod:`prdforge.llm` when it builds the
...
from prdforge.backends.base import ON_CHUNK, StreamChunk

logger = logging.getLogger(__name__)

__all__ = ["Narrator", "current_sink", "encode", "decode", "stream_to", "MARKER"]

_SINK: ContextVar[ON_CHUNK | None] = ContextVar("prdforge_stream_sink", default=None)
