...
The original - and still the default - way SourceWork reaches a model. LiteLLM
...
def _blind_model_error(exc: Exception, model: str | None) -> str | None:
    ...
    return (
        ...
        f"SOURCEWORK_LLM__VISION_MODEL at a multimodal model - for a local server that means "
