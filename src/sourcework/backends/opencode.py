...
pipeline against models SourceWork has no credentials for.
...
ANSWER_AGENT = "sourcework-answer"

_ANSWER_AGENT_BODY = """---
description: Single-shot answerer for SourceWork - no tools, no narration.
mode: primary
tools:
  write: false
  edit: false
...
class OpenCodeBackend(LLMBackend):
    ...
    def _build_argv(
        ...
        # SourceWork call, spending an account nobody chose, on a title that is
        ...
        argv += ["--title", "sourcework", "--format", "json"]
